 ...
 * `onProgress(1)` incondicional. Ese `1` es la única señal disponible de
 * "la próxima llamada que llegue es ya de la pista siguiente" — no hay forma
 * de saber el índice desde fuera salvo contando esas transiciones.
 *
