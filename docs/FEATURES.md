...
| **La caché de samples del render deja de crecer**: vivía en el hilo de la UI y no la vaciaba nadie. Cinco proyectos de dieciséis tomas largas acumulaban 6460 MiB; ahora quedan 1292, lo que registra el proyecto abierto. Se desaloja al final de `collectSamples()`, nunca antes, así que jamás tira algo que la propia llamada necesita | v3.7 |
