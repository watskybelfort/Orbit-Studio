...
| **Las dependencias de los hooks, revisadas una a una**: seis de los once avisos eran bugs reales —manejadores del piano roll y la playlist leyendo valores rancios— y los cinco que sobran a propósito ahora dicen por qué. `exhaustive-deps` pasa de aviso a error: uno nuevo rompe la CI en vez de sumarse a la pila | v3.7 |
